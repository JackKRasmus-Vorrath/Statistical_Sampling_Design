...
val_df <- setNames(data.frame(matrix(ncol = 6, nrow = 11)), 
                   c('Mean_Estimate','Mean_95%_CI','Includes_True_Mean','Total_Estimate','Total_95%_CI','Includes_True_Total'))
...
val_df[,2] <- c('[162988.75, 176524.17]','[164504.66, 177553.81]','[164213.25, 177670.19]','[171569.94, 189752.80]','[179888.87, 198055.35]',
                '[175971.11, 194300.55]','[170747.97, 188949.05]','[174797.44, 193353.68]','[172703.45, 192463.72]','[163986.30, 177529.80]',
                '[-84007.23, 712884.27]')

val_df[,3] <- c('NO','NO','NO','YES','NO',
                'YES','YES','YES','YES','NO',
                'YES*')

val_df[,4] <- c(1657162517.56, 1669587375.01, 1668733077.91, 1763616255.09, 1844745764.38,
                1807295957.79, 1755681139.99, 1796945610.77, 1782380939.82, 1666940099.01,
                157219259.33)

val_df[,5] <- c('[1591096127.57, 1723228907.55]','[1605894485.29, 1733280264.72]','[1603049730.45, 1734416425.36]','[1674865723.84, 1852366786.34]','[1756075189.22, 1933416339.54]',
